...
public:
    ...
    void update();
    void setUI();
    void displayData(OLEDDisplay *display, OLEDDisplayUiState* state, int16_t x, int16_t y);
    void displayLogo(OLEDDisplay *display, OLEDDisplayUiState* state, int16_t x, int16_t y);
